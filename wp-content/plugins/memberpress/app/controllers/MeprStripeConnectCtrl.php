...
class MeprStripeConnectCtrl extends MeprBaseCtrl {
  ...
  public function upgrade_notice() {
    if ( MeprStripeGateway::has_method_with_connect_status( 'not-connected' ) && ( ! isset( $_COOKIE['mepr_stripe_connect_upgrade_dismissed'] ) || false == $_COOKIE['mepr_stripe_connect_upgrade_dismissed'] ) ) {
      ?>
        <div class="notice notice-warning mepr-notice is-dismissible" id="mepr_stripe_connect_upgrade_notice">
          <p>
            ...
            <p><?php _e( 'Some of your payment methods are connected to Stripe in a way that\'s out of date and could become insecure.', 'memberpress' ); ?></p>
            <p><?php printf( __( 'This is easy to fix, just %sclick here%s and re-connect your Stripe payment methods.', 'memberpress' ), '<a href="' . admin_url( 'admin.php?page=memberpress-options#mepr-integration' ) . '">', '</a>' ); ?></a></p>
          </p>
